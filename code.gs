...
function getData() {
  return SpreadsheetApp
      .openById('18hj2THDxTU9CxKN8tFSdMvB9fJDszK0PQHyNWizRChU')
      .getActiveSheet()
      .getDataRange()
      .getValues();
}
...
- create setup file or input setup file URL (after sharing)
-> values
-> taf.
...
// get rid of timezone
// add time stamp and mail_id stamp in file names
// document options.gs
